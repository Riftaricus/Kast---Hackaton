...
namespace Kast___Hackaton
{
    public class Factory
    {
        ...
        private static readonly Subscription[] subscriptions = { new CursusSubscription(), new OncePerWeekSubscription(), new TwicePerWeekSubscription(), new UnlimitedSubscription() };
        private static Sporter GenerateSporter()
        {
            ...
            Subscription subscription = subscriptions[random.Next(0, subscriptions.Length)];

            return new Sporter(firstName, lastName, subscription);
